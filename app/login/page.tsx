...
const login = () => {
  return (
    <div className="bg-yellow-400 h-screen overflow-hidden flex items-center justify-center">
      <div className="bg-white lg:w-5/12 md:5/12 w-8/12 shadow-3xl">
        <Link href="/">
        ...
        <form className="p-12 md:p-24">
          ...
          <Button
          className='bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded-none justify-center'
          >Login</Button>
        </form>
      </div>
    </div>
